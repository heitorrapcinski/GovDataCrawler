...
_FIELD_LABEL_MAP: dict[str, list[str]] = {
    ...
    "contract_number": ["Número do Contrato", "Contrato"],
    "supplier_name": ["Fornecedor", "Razão Social"],
    "contract_value": ["Valor do Contrato", "Valor"],
    "start_date": ["Data de Início", "Início", "Vigência Início"],
    "end_date": ["Data de Término", "Término", "Vigência Fim"],
...
class DetailParser:
    ...
    def parse(self, html: str, contract_id: str) -> ContractMetadata:
        ...
        Scans for ``<span class="field-label">`` / ``<span class="field-value">``
        pairs inside ``<div class="field-group">`` elements and maps them to
        :class:`ContractMetadata` fields.
